...
TABLE_CONFIGS: dict[str, dict] = {
    ...
    "ScoreboardPlayers": {
        ...
        # LIKE patterns on OverviewPage avoid the IN(N) filter that triggers
        # aggressive rate limiting regardless of account.
        # LFL pages start with 'LFL/', EMEA Masters pages with 'EMEA Masters/'.
        "where": "OverviewPage LIKE 'LFL/%' OR OverviewPage LIKE 'EMEA Masters/%'",
        "order_by": "GameId",
        "limit": 500,
    },
    "PicksAndBansS7": {
